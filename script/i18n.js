...
const translations = {
    en: {
        ...
        newRunSaveWarning: "A resumable adventure is already saved.\n\nPress OK to delete the current save and start a new descent.\nThis cannot be undone.",
        vitality: "HP",
        floor: "FLOOR",
        essence: "Essence",
        turn: "TURN",
    ...
    ja: {
        ...
        startBtn: "新たな探索",
        continueBtn: "つづきから",
        newRunSaveWarning: "「つづきから」で遊べるセーブデータがあります。\n\n「OK」を押すと現在のセーブデータを削除して、新たな探索を開始します。\nこの操作は元に戻せません。",
        vitality: "HP",
        floor: "階層",
        essence: "エッセンス",
        turn: "ターン",
